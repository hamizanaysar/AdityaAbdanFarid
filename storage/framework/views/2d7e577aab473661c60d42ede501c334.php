...
<?php $__env->startSection('judul_halaman', 'TAMBAH DATA BANTUAN TUNAI LANGSUNG'); ?>
<!-- isi bagian konten -->
            ...
            <div class="card-body">
                <form action="<?php echo e(route('rumah.store')); ?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="dana" placeholder="Jumlah Dana" class="form-control" value="<?php echo e(old('dana')); ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
...
<?php echo $__env->make('template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\appBantuan\resources\views/rumah/create.blade.php ENDPATH**/ ?>