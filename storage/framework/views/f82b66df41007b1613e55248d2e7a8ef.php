...
<?php $__env->startSection('judul_halaman', 'HALAMAN UTAMA BANTUAN BEDAH
RUMAH'); ?>
<!-- isi bagian konten -->
<?php $__env->startSection('konten'); ?>
<!-- <a href="<?php echo e(route('rumah.create')); ?>" type="button" class="btn btn-success">
    Tambah Data
</a> -->
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="basic example">
                        <a href="<?php echo e(route('rumah.show',$data->id)); ?>" class="btn btn-small btn-secondary">Detail</a>
                        <a href="<?php echo e(route('rumah.edit',$data->id)); ?>" class="btn btn-small btn-warning">Edit</a>
                        <form action="<?php echo e(route('rumah.destroy',$data->id)); ?>" method="POST" onsubmit="return confirm('Apakah yakin menghapus data ini?')">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\appBantuan\resources\views/rumah/rumah.blade.php ENDPATH**/ ?>